...
from app.schemas import StudentUpdate, StudentCreate


class CRUDStudent(CRUDBase[models.Student, StudentCreate, StudentUpdate]):
    async def create(
        ...
        student_in = schemas.StudentUpdate(
            id=user_db_obj.id, **obj_in.dict(exclude_none=True)
        )
