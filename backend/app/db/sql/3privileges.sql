...
grant insert, select, update         on table reserved_usernames to admin;
...
grant         select         on table reserved_usernames to student;
grant         select, update on table student to student; --rls id:id
grant         select, update on table student_task to student; --rls student_id:id
grant insert, select, update on table student_task_store to student; --rls student_id:id
...
grant         select         on table teacher to student; --rls by discipline_id:study_group:discipline_id
grant insert, select, update on table "user" to student; --rls id:id



grant insert, select, update on table discipline to leader;
grant insert, select, update on table campus to leader;
grant         select         on table reserved_usernames to leader;
...
grant         select         on table reserved_usernames to teacher;
