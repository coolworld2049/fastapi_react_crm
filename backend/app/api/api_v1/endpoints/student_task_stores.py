...
async def read_task_stores(
        ...
        request_params: RequestParams = Depends(deps.parse_react_admin_params(models.StudentTaskStore))
) -> Any:
    """
    Retrieve StudentTaskStores.
    """
    items, total = await crud.student_task_store.get_multi(db, request_params=request_params)
